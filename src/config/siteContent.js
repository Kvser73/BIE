...
export const siteContent = {
  ...
  nav: [
    ...
    { key: 'code', label: 'CODE', url: 'https://github.com/Kvser73/BIE-code' },
  ...
  sections: {
    performance: {
      title: 'Performance',
      panelTitle: 'Life science images enhancement',
      image: {
    ...
    resultVideo: {
      title: 'Life science vedios enhancement',
      videos: [
        {
          key: 'result_video_1',
          slot: 'result',
    ...
    extensibility: {
      ...
      introLines: ['Beyond the life sciences domain, the BIE framework can be readily extended to other fields. Here we present the enhancement results from annotation tests on a subset of data, indicating that BIE can be easily generalized to these domains.'],
      blocks: [
        {
          key: 'ext_1',
