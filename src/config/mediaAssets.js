...
export const mediaAssets = {
  ...
  resultVideo: {
    ...
    // result_video_3 uses the extracted 46s frame stored under videos/ so both preview and
    // original-style paths stay aligned with the replaced OSS cover objects.
    video3Poster: {
      previewUrl: buildOssAsset(PREVIEW_BASE_URL, PREVIEW_PREFIX, 'videos/屏幕录制-封面.png'),
      originalPreviewUrl: buildOssAsset(PREVIEW_BASE_URL, ORIGINAL_PREFIX, 'videos/屏幕录制-封面.png'),
      downloadUrl: buildOssAsset(DOWNLOAD_BASE_URL, DOWNLOAD_PREFIX, 'videos/屏幕录制-封面.png'),
    },
  },
  dataset: {
